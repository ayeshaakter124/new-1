...
export default function Journey() {
  ...
  return (
    <section id="journey" className="py-16 sm:py-24 bg-primary relative overflow-hidden">
      {/* Background Glows */}
      <div className="absolute top-1/4 left-0 w-[240px] sm:w-[400px] h-[240px] sm:h-[400px] bg-accent/5 rounded-full blur-[50px] sm:blur-[70px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-0 w-[200px] sm:w-[350px] h-[200px] sm:h-[350px] bg-panel/5 rounded-full blur-[50px] sm:blur-[70px] pointer-events-none" />
