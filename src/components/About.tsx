        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-3 -right-3 sm:-bottom-6 sm:-right-6 glass p-3 sm:p-6 rounded-[16px] sm:rounded-[32px] z-20 border border-accent/20 glow-md text-center sm:text-left">
              <p className="text-xl sm:text-4xl font-display font-bold text-accent tracking-tighter leading-none">{settings.yearsExperience || "2+"}</p>
          ...
          >
            ...
            <p className="text-xs md:text-lg text-text-soft mb-6 sm:mb-10 leading-relaxed font-light">
              Based in the pulse of the digital design landscape, I specialize in distilling complex narratives into visual poetry. 
              My journey is anchored in film aesthetics, evolving into a dedicated mission to help modern brands and creators define their visual legacy.
            </p>
            ...
            <div className="mt-8 sm:mt-10 flex flex-wrap gap-8 sm:gap-10">
              <div>
                <p className="text-xl sm:text-2xl font-display font-bold text-text-pure tracking-tighter text-glow">{settings.projectsCompleted || "183+"}</p>
                <p className="text-[8px] sm:text-[9px] text-text-muted uppercase font-bold tracking-[0.3em] mt-1">Projects Done</p>
              </div>
              <div>
                <p className="text-xl sm:text-2xl font-display font-bold text-text-pure tracking-tighter text-glow">{settings.happyClients || "47+"}</p>
